...
public class ModOreVeins {
    ...
    public static final OreVein COPPER_VEIN = 
        addOreVein("copper").addOre(ModMaterials.COPPER, 1).setData(16, 16, 0.75f, -48, 128);
    public static final OreVein IRON_VEIN =
        addOreVein("iron").addOre(ModMaterials.IRON, 1).setData(16, 16, 0.75f, -48, 128);
    public static final OreVein COAL_VEIN = 
        addOreVein("coal").addOre(ModMaterials.COAL, 1).setData(16, 32, 0.75f, -48, 128);
